...
import bhusal.ujjwal.androidproject.roomdb.ProductDB
...
class AddProduct : AppCompatActivity() {
    ...
    lateinit var rbGrocery: RadioButton
    lateinit var rbClothes: RadioButton
    lateinit var rbFoods: RadioButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rbGrocery = findViewById(R.id.rbGrocery)
        imgAddImage = findViewById(R.id.imgAddImage)
        imgAddImage.setOnClickListener {
            loadPopUpMenu()
        }
        rbClothes = findViewById(R.id.rbClothes)
        rbFoods = findViewById(R.id.rbFoods)
        btnAdd = findViewById(R.id.btnAdd)
        btnAdd.setOnClickListener {
            when {
                rbGrocery.isChecked -> category = rbGrocery.text.toString()
                rbClothes.isChecked -> category = rbClothes.text.toString()
                rbFoods.isChecked -> category = rbFoods.text.toString()
            }
